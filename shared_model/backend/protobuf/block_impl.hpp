...
#ifndef IROHA_SHARED_MODEL_PROTO_BLOCK_IMPL_HPP
#define IROHA_SHARED_MODEL_PROTO_BLOCK_IMPL_HPP
...
namespace shared_model {
  namespace proto {
    class BlockImpl : public NonCopyableProto<interface::Block,
                                              iroha::protocol::Block,
                                              BlockImpl> {
     public:
      using NonCopyableProto::NonCopyableProto;

      BlockImpl(BlockImpl &&o) noexcept;
      BlockImpl &operator=(BlockImpl &&o) noexcept;
...
#endif  // IROHA_SHARED_MODEL_PROTO_BLOCK_IMPL_HPP
