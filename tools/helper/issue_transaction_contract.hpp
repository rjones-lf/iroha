    ...
    namespace contract {
      namespace account {
        void issue_transaction(std::vector<std::string> &argv) {
          try {
            auto
                tx = txbuilder::TransactionBuilder<type_signatures::Contract<type_signatures::Account >>()
...
//TODO                                txbuilder::createAccount( argv[0], argv[1], txbuilder::createTrust( stod(argv[2]), argv[3]=="true" ) )
      ...
      namespace asset {
        void issue_transaction(std::vector<std::string> &argv) {
          try {
            auto
                tx = txbuilder::TransactionBuilder<type_signatures::Contract<type_signatures::Asset >>()
                .setSenderPublicKey(::peer::myself::getPublicKey())
//TODO                                txbuilder::createAsset( argv[0], argv[1], txbuilder::createTrust( stod(argv[2]), argv[3]=="true" ) )
      ...
      namespace peer {
        void issue_transaction(std::vector<std::string> &argv) {
          try {
            auto
                tx = txbuilder::TransactionBuilder<type_signatures::Contract<type_signatures::Peer >>()
                .setSenderPublicKey(::peer::myself::getPublicKey())
                .setPeer(
      ...
      namespace domain {
        void issue_transaction(std::vector<std::string> &argv) {
          try {
            auto
                tx = txbuilder::TransactionBuilder<type_signatures::Contract<type_signatures::Domain >>()
                .setSenderPublicKey(::peer::myself::getPublicKey())
                .setDomain(
