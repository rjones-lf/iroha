...
namespace iroha {
  namespace model {
    ...
    ExecutionResult CreateAccountExecutor::execute(
      ...
      if (not commands.insertAccountSignatory(
              account.account_id,
    ...
    ExecutionResult RemoveSignatoryExecutor::execute(
      ...
      if (not commands.deleteAccountSignatory(
    ...
    ExecutionResult SetQuorumExecutor::execute(
      ...
      return errorIfNot(commands.updateAccount(acc),
