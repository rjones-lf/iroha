...
namespace iroha {
  namespace ametsuchi {
     ...
     * in case of result contains error
     */
    CommandResult makeCommandResultByReturnedValue(
        soci::statement &st,
        std::string command_name,
    ...
    CommandResult PostgresCommandExecutor::operator()(
      ...
      return makeCommandResultByReturnedValue(st, "AddAssetQuantity", message_gen);
    }
    ...
    CommandResult PostgresCommandExecutor::operator()(
      ...
      return makeCommandResultByReturnedValue(st, "RemoveSignatory", message_gen);
    }
    ...
    CommandResult PostgresCommandExecutor::operator()(
      ...
      return makeCommandResultByReturnedValue(st, "SubtractAssetQuantity", message_gen);
    }
