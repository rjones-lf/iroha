...
.. csv-table::
    ...
    "4", "Summation overflow", "Resulting amount of asset is greated than the system can support", "Make sure that resulting amount is less than [256]_
...
.. csv-table::
    ...
    "7", "Too much asset to transfer", "Resulting value of asset amount overflows destination account's amount", "Make sure final value is less than 2 [256]_
