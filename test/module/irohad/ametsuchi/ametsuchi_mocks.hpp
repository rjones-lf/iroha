...
namespace iroha {
  namespace ametsuchi {
    ...
    class MockCommandExecutor : public iroha::ametsuchi::CommandExecutor {
     public:
      ...
      MOCK_METHOD1(addPeer,
                   WsvCommandResult(const shared_model::interface::Peer &));

      MOCK_METHOD2(addSignatory,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::PubkeyType &));

      MOCK_METHOD2(appendRole,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::RoleIdType &));
      MOCK_METHOD3(createAccount,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
      ...
      MOCK_METHOD2(
          createDomain,
          WsvCommandResult(const shared_model::interface::types::DomainIdType &,
                           const shared_model::interface::types::RoleIdType &));

      MOCK_METHOD2(
          createRole,
          WsvCommandResult(const shared_model::interface::types::RoleIdType &,
                           const shared_model::interface::RolePermissionSet &));
      MOCK_METHOD2(detachRole,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::RoleIdType &));
      ...
      MOCK_METHOD4(setAccountDetail,
                   WsvCommandResult(const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::AccountIdType &,
                       const std::string &,
                       const std::string &));

      MOCK_METHOD2(setQuorum,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::QuorumType));

      MOCK_METHOD4(subtractAssetQuantity,
                   WsvCommandResult(
                       const shared_model::interface::types::AccountIdType &,
                       const shared_model::interface::types::AssetIdType &,
                       const std::string &,
